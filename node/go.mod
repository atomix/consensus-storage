...
require (
	github.com/atomix/multi-raft-storage/api v0.1.1-0.20220731085348-ef95a594ce50
...
require (
	...
	github.com/atomix/runtime/api v0.1.1-0.20220731065539-c3d767efc511 // indirect
