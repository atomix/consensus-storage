...
// Source: github.com/atomix/multi-raft-storage/node/pkg/statemachine (interfaces: Context,SessionManager,SessionManagerContext,OpenSessionProposal,KeepAliveProposal,CloseSessionProposal,SessionProposal,SessionQuery)
