...
var Type = primitive.NewType[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput](Service, counterMapCodec, newMapStateMachine)

var counterMapCodec = primitive.NewCodec[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput](
...
type MapStateMachine struct {
	...
	increment primitive.Proposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.IncrementInput, *countermapv1.IncrementOutput]
	decrement primitive.Proposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.DecrementInput, *countermapv1.DecrementOutput]
	clear     primitive.Proposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.ClearInput, *countermapv1.ClearOutput]
	events    primitive.Proposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.EventsInput, *countermapv1.EventsOutput]
	size      primitive.Querier[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.SizeInput, *countermapv1.SizeOutput]
	get       primitive.Querier[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.GetInput, *countermapv1.GetOutput]
...
func (s *MapStateMachine) init() {
	s.put = primitive.NewProposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.SetInput, *countermapv1.SetOutput](s).
		...
		Build(s.doSet)
	s.insert = primitive.NewProposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.InsertInput, *countermapv1.InsertOutput](s).
		Name("Insert").
		...
		Build(s.doInsert)
	s.update = primitive.NewProposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.UpdateInput, *countermapv1.UpdateOutput](s).
		Name("Update").
		...
		Build(s.doUpdate)
	s.remove = primitive.NewProposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.RemoveInput, *countermapv1.RemoveOutput](s).
		Name("Remove").
		...
		Build(s.doRemove)
	s.increment = primitive.NewProposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.IncrementInput, *countermapv1.IncrementOutput](s).
		Name("Increment").
		...
		Build(s.doIncrement)
	s.decrement = primitive.NewProposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.DecrementInput, *countermapv1.DecrementOutput](s).
		Name("Decrement").
		...
		Build(s.doDecrement)
	s.clear = primitive.NewProposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.ClearInput, *countermapv1.ClearOutput](s).
		Name("Clear").
		...
		Build(s.doClear)
	s.events = primitive.NewProposer[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.EventsInput, *countermapv1.EventsOutput](s).
		Name("Events").
		...
		Build(s.doEvents)
	s.size = primitive.NewQuerier[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.SizeInput, *countermapv1.SizeOutput](s).
		Name("Size").
		...
		Build(s.doSize)
	s.get = primitive.NewQuerier[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.GetInput, *countermapv1.GetOutput](s).
		Name("Get").
		...
		Build(s.doGet)
	s.list = primitive.NewQuerier[*countermapv1.CounterMapInput, *countermapv1.CounterMapOutput, *countermapv1.EntriesInput, *countermapv1.EntriesOutput](s).
		Name("Entries").
