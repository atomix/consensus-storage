...
import (
	"context"
	api "github.com/atomix/multi-raft-storage/api/atomix/multiraft/atomic/countermap/v1"
...
const Service = "atomix.multiraft.atomic.countermap.v1.AtomicCounterMap"

func NewAtomicCounterMapServer(protocol *client.Protocol) atomiccountermapv1.AtomicCounterMapServer {
	return &multiRaftAtomicCounterMapServer{
		Protocol: protocol,
	}
}

type multiRaftAtomicCounterMapServer struct {
	*client.Protocol
}

func (s *multiRaftAtomicCounterMapServer) Create(ctx context.Context, request *atomiccountermapv1.CreateRequest) (*atomiccountermapv1.CreateResponse, error) {
	log.Debugw("Create",
...
func (s *multiRaftAtomicCounterMapServer) Close(ctx context.Context, request *atomiccountermapv1.CloseRequest) (*atomiccountermapv1.CloseResponse, error) {
	log.Debugw("Close",
...
func (s *multiRaftAtomicCounterMapServer) Size(ctx context.Context, request *atomiccountermapv1.SizeRequest) (*atomiccountermapv1.SizeResponse, error) {
	log.Debugw("Size",
	...
	sizes, err := async.ExecuteAsync[int](len(partitions), func(i int) (int, error) {
		...
		output, err := query.Run(func(conn *grpc.ClientConn, headers *multiraftv1.QueryRequestHeaders) (*api.SizeResponse, error) {
			return api.NewAtomicCounterMapClient(conn).Size(ctx, &api.SizeRequest{
				Headers:   headers,
...
func (s *multiRaftAtomicCounterMapServer) Set(ctx context.Context, request *atomiccountermapv1.SetRequest) (*atomiccountermapv1.SetResponse, error) {
	log.Debugw("Set",
	...
	output, err := command.Run(func(conn *grpc.ClientConn, headers *multiraftv1.CommandRequestHeaders) (*api.SetResponse, error) {
		...
		return api.NewAtomicCounterMapClient(conn).Set(ctx, input)
	})
	if err != nil {
		log.Warnw("Set",
			logging.Stringer("SetRequest", request),
...
func (s *multiRaftAtomicCounterMapServer) Insert(ctx context.Context, request *atomiccountermapv1.InsertRequest) (*atomiccountermapv1.InsertResponse, error) {
	log.Debugw("Insert",
	...
	_, err = command.Run(func(conn *grpc.ClientConn, headers *multiraftv1.CommandRequestHeaders) (*api.InsertResponse, error) {
		return api.NewAtomicCounterMapClient(conn).Insert(ctx, &api.InsertRequest{
			Headers: headers,
...
func (s *multiRaftAtomicCounterMapServer) Update(ctx context.Context, request *atomiccountermapv1.UpdateRequest) (*atomiccountermapv1.UpdateResponse, error) {
	log.Debugw("Update",
	...
	output, err := command.Run(func(conn *grpc.ClientConn, headers *multiraftv1.CommandRequestHeaders) (*api.UpdateResponse, error) {
		...
		return api.NewAtomicCounterMapClient(conn).Update(ctx, input)
	})
	if err != nil {
		log.Warnw("Update",
			logging.Stringer("UpdateRequest", request),
...
func (s *multiRaftAtomicCounterMapServer) Increment(ctx context.Context, request *atomiccountermapv1.IncrementRequest) (*atomiccountermapv1.IncrementResponse, error) {
	...
	output, err := command.Run(func(conn *grpc.ClientConn, headers *multiraftv1.CommandRequestHeaders) (*api.IncrementResponse, error) {
		...
		return api.NewAtomicCounterMapClient(conn).Increment(ctx, input)
	})
	if err != nil {
		log.Warnw("Increment",
			logging.Stringer("IncrementRequest", request),
...
func (s *multiRaftAtomicCounterMapServer) Decrement(ctx context.Context, request *atomiccountermapv1.DecrementRequest) (*atomiccountermapv1.DecrementResponse, error) {
	...
	output, err := command.Run(func(conn *grpc.ClientConn, headers *multiraftv1.CommandRequestHeaders) (*api.DecrementResponse, error) {
		...
		return api.NewAtomicCounterMapClient(conn).Decrement(ctx, input)
	})
	if err != nil {
		log.Warnw("Decrement",
			logging.Stringer("DecrementRequest", request),
...
func (s *multiRaftAtomicCounterMapServer) Get(ctx context.Context, request *atomiccountermapv1.GetRequest) (*atomiccountermapv1.GetResponse, error) {
	log.Debugw("Get",
	...
	output, err := query.Run(func(conn *grpc.ClientConn, headers *multiraftv1.QueryRequestHeaders) (*api.GetResponse, error) {
		return api.NewAtomicCounterMapClient(conn).Get(ctx, &api.GetRequest{
			Headers: headers,
...
func (s *multiRaftAtomicCounterMapServer) Remove(ctx context.Context, request *atomiccountermapv1.RemoveRequest) (*atomiccountermapv1.RemoveResponse, error) {
	log.Debugw("Remove",
	...
	output, err := command.Run(func(conn *grpc.ClientConn, headers *multiraftv1.CommandRequestHeaders) (*api.RemoveResponse, error) {
		...
		return api.NewAtomicCounterMapClient(conn).Remove(ctx, input)
	})
	if err != nil {
		log.Warnw("Remove",
			logging.Stringer("RemoveRequest", request),
...
func (s *multiRaftAtomicCounterMapServer) Clear(ctx context.Context, request *atomiccountermapv1.ClearRequest) (*atomiccountermapv1.ClearResponse, error) {
	log.Debugw("Clear",
	...
	err := async.IterAsync(len(partitions), func(i int) error {
		...
		_, err = command.Run(func(conn *grpc.ClientConn, headers *multiraftv1.CommandRequestHeaders) (*api.ClearResponse, error) {
			return api.NewAtomicCounterMapClient(conn).Clear(ctx, &api.ClearRequest{
				Headers:    headers,
...
func (s *multiRaftAtomicCounterMapServer) Lock(ctx context.Context, request *atomiccountermapv1.LockRequest) (*atomiccountermapv1.LockResponse, error) {
	log.Debugw("Lock",
	...
	err := async.IterAsync(len(partitionIndexes), func(i int) error {
		...
		_, err = command.Run(func(conn *grpc.ClientConn, headers *multiraftv1.CommandRequestHeaders) (*api.LockResponse, error) {
			return api.NewAtomicCounterMapClient(conn).Lock(ctx, &api.LockRequest{
				Headers: headers,
...
func (s *multiRaftAtomicCounterMapServer) Unlock(ctx context.Context, request *atomiccountermapv1.UnlockRequest) (*atomiccountermapv1.UnlockResponse, error) {
	log.Debugw("Unlock",
	...
	err := async.IterAsync(len(partitions), func(i int) error {
		...
		_, err = command.Run(func(conn *grpc.ClientConn, headers *multiraftv1.CommandRequestHeaders) (*api.UnlockResponse, error) {
			return api.NewAtomicCounterMapClient(conn).Unlock(ctx, &api.UnlockRequest{
				Headers:     headers,
...
func (s *multiRaftAtomicCounterMapServer) Events(request *atomiccountermapv1.EventsRequest, server atomiccountermapv1.AtomicCounterMap_EventsServer) error {
	log.Debugw("Events",
	...
	return async.IterAsync(len(partitions), func(i int) error {
		...
		command := client.StreamCommand[api.AtomicCounterMap_EventsClient, *api.EventsResponse](primitive)
		stream, err := command.Open(func(conn *grpc.ClientConn, headers *multiraftv1.CommandRequestHeaders) (api.AtomicCounterMap_EventsClient, error) {
			return api.NewAtomicCounterMapClient(conn).Events(server.Context(), &api.EventsRequest{
				Headers: headers,
...
func (s *multiRaftAtomicCounterMapServer) Entries(request *atomiccountermapv1.EntriesRequest, server atomiccountermapv1.AtomicCounterMap_EntriesServer) error {
	log.Debugw("Entries",
	...
	return async.IterAsync(len(partitions), func(i int) error {
		...
		query := client.StreamQuery[api.AtomicCounterMap_EntriesClient, *api.EntriesResponse](primitive)
		stream, err := query.Open(func(conn *grpc.ClientConn, headers *multiraftv1.QueryRequestHeaders) (api.AtomicCounterMap_EntriesClient, error) {
			return api.NewAtomicCounterMapClient(conn).Entries(server.Context(), &api.EntriesRequest{
				Headers: headers,
...
var _ atomiccountermapv1.AtomicCounterMapServer = (*multiRaftAtomicCounterMapServer)(nil)
