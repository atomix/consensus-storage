...
func (m *DemoteRequest) GetHeaders() *v1.CommandRequestHeaders {
	if m != nil {
		return m.Headers
	}
	return nil
...
func (m *DemoteResponse) GetHeaders() *v1.CommandResponseHeaders {
	if m != nil {
		return m.Headers
	}
	return nil
...
func (*WatchRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_afe1ecf9e53c1ebc, []int{14}
}
...
func (*WatchResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_afe1ecf9e53c1ebc, []int{15}
}
...
func init() {
	...
	proto.RegisterType((*DemoteRequest)(nil), "atomix.multiraft.election.v1.DemoteRequest")
	proto.RegisterType((*DemoteResponse)(nil), "atomix.multiraft.election.v1.DemoteResponse")
...
var fileDescriptor_afe1ecf9e53c1ebc = []byte{
	...
	,
}
...
func (c *leaderElectionClient) Demote(ctx context.Context, in *DemoteRequest, opts ...grpc.CallOption) (*DemoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/atomix.multiraft.election.v1.LeaderElection/Demote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LeaderElection_Demote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/atomix.multiraft.election.v1.LeaderElection/Demote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
