...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiRaftStoreConfig) DeepCopyInto(out *MultiRaftStoreConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiRaftStoreConfig.
func (in *MultiRaftStoreConfig) DeepCopy() *MultiRaftStoreConfig {
	if in == nil {
		return nil
	}
	out := new(MultiRaftStoreConfig)
	in.DeepCopyInto(out)
	return out
}
