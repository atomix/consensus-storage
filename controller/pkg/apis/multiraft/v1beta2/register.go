...
// Package v1beta2 contains API Schema definitions for the multiraft v1beta2 API group
...
var SchemeGroupVersion = schema.GroupVersion{Group: "multiraft.atomix.io", Version: "v1beta2"}
